const cartItems = [
    { id: 1, name: 'Idly (2 Pieces)', description: 'The South Indian Breakfast', quantity: 2, price: 50, available: 5, image: './img/CtQfTmJUMAE-ihJ.jpg' },
    { id: 2, name: 'Crispy Masala Dosa', description: 'The Classic Masterpiece', quantity: 2, price: 50, available: 3, image: './img/images1.jpg' },
    { id: 3, name: 'Oat Meal', description: 'The healthiest grains on earth', quantity: 2, price: 50, available: 4, image: './img/as-oatmeal-cpmk-superJumbo.jpg' },
];
...
const additionalProducts = [
    { id: 4, name: 'Tom Yam', description: 'Tailand classic', price: 80, available: 4, image: './img/2297-pho-bo.jpg' },
    { id: 5, name: 'Spring rolls', description: 'Chinas mivinas', price: 70, available: 10, image: './img/2297-Ramen.jpg' },
    { id: 6, name: 'Ramen', description: 'Japones soup', price: 50, available: 5, image: './img/2297-tom-yum.jpg' },
];
